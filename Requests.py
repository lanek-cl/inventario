...
def New_entry(Ent, Inv):
    ...
    if  last_entry_cat == "Componente":
        ...
        func.Add_Comp(Inv, id, last_entry_cat, last_entry_fam, last_entry_des, int(last_entry_qty))
        ...
        func.Add_Insu(Inv, id, last_entry_cat, last_entry_fam, last_entry_des, int(last_entry_qty))
...
def New_out(Out, Inv):
    ...
    if  last_out_cat == "Componente":
        ...
        func.Add_Comp(Inv, id, last_out_cat, last_out_fam, last_out_des, -int(last_out_qty))
        ...
        func.Add_Insu(Inv, id, last_out_cat, last_out_fam, last_out_des, -int(last_out_qty))
